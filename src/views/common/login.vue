...
<!--        <div class="logo"><img src="~@/assets/img/login-logo.png" alt=""></div>-->
      ...
      <div class="bottom">Copyright © 2019 深圳三诺数字科技有限公司</div>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    dataFormSubmit () {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.$http({
            url: this.$http.adornUrl('/login?grant_type=Basic M25vZF9zeXN0ZW06c3lzdGVtQDNub2Q='),
    ...
    getCaptcha () {
      ...
      // this.captchaPath = this.axios.get(`http://192.168.107.38:8066/code/image`)
    }
  }
}
</script>
